...
<defs>
            ...
            <div id="pic1" class="pic">
                <img src="{{asset('./pic-1.png')}}" alt="" />
                <div class="content_card custom">
                    <div class="heading_line">
                        <h4 class="fw-800" style="font-family: 'Playfair Display', seri; font-size: 94px">XIN CẢM ƠN</h4>
                        <div class="heading_name" style="font-family: 'Playfair Display', seri; font-size: 30px; color: #535750">
                            <p>Thông tin đã được ghi nhận.
                    ...
                    <div class="image-gallery">
                        <img style="flex: 0 0 auto; width: 50%;" src="{{asset('./pic-1.png')}}" alt="">
                        <img style="flex: 0 0 auto; width: 50%;" src="{{asset('./pic-1.png')}}" alt="">
                    </div>
                    <div style="font-family: 'Playfair Display', seri; font-size: 40px;">
                        Trân trọng!
